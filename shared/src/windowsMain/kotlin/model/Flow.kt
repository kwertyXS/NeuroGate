...
class Flow(
    ...
    fun toFeatureVector(): FloatArray {
        ...
        val features = listOf(
            durationMicro.toFloat(),
            totalFwdPackets.toFloat(),
            totalBwdPackets.toFloat(),
            totalFwdBytes.toFloat(),
            totalBwdBytes.toFloat(),
            (fwdLenStats["max"] ?: 0.0).toFloat(),
            (fwdLenStats["min"] ?: 0.0).toFloat(),
            (fwdLenStats["mean"] ?: 0.0).toFloat(),
            (fwdLenStats["std"] ?: 0.0).toFloat(),
            (bwdLenStats["max"] ?: 0.0).toFloat(),
            (bwdLenStats["min"] ?: 0.0).toFloat(),
            (bwdLenStats["mean"] ?: 0.0).toFloat(),
            (bwdLenStats["std"] ?: 0.0).toFloat(),
            flowBytesPerSec.toFloat(),
            flowPacketsPerSec.toFloat(),
            (flowIatStats["mean"] ?: 0.0).toFloat(),
            (flowIatStats["std"] ?: 0.0).toFloat(),
            (flowIatStats["max"] ?: 0.0).toFloat(),
            (flowIatStats["min"] ?: 0.0).toFloat(),
            (fwdIatStats["sum"] ?: 0.0).toFloat(),
            (fwdIatStats["mean"] ?: 0.0).toFloat(),
            (fwdIatStats["std"] ?: 0.0).toFloat(),
            (fwdIatStats["max"] ?: 0.0).toFloat(),
            (fwdIatStats["min"] ?: 0.0).toFloat(),
            (bwdIatStats["sum"] ?: 0.0).toFloat(),
            (bwdIatStats["mean"] ?: 0.0).toFloat(),
            (bwdIatStats["std"] ?: 0.0).toFloat(),
            (bwdIatStats["max"] ?: 0.0).toFloat(),
            (bwdIatStats["min"] ?: 0.0).toFloat(),
            fwdPshFlags.toFloat(),
            bwdPshFlags.toFloat(),
            fwdUrgFlags.toFloat(),
            bwdUrgFlags.toFloat(),
            fwdHeaderLengthSum.toFloat(),
            bwdHeaderLengthSum.toFloat(),
            fwdPacketsPerSec.toFloat(),
            bwdPacketsPerSec.toFloat(),
            (pktLenStats["min"] ?: 0.0).toFloat(),
            (pktLenStats["max"] ?: 0.0).toFloat(),
            (pktLenStats["mean"] ?: 0.0).toFloat(),
            (pktLenStats["std"] ?: 0.0).toFloat(),
            (pktLenStats["std"]?.let { it * it } ?: 0.0).toFloat(), // Variance
            finFlagCount.toFloat(),
            synFlagCount.toFloat(),
            rstFlagCount.toFloat(),
            pshFlagCount.toFloat(),
            ackFlagCount.toFloat(),
            urgFlagCount.toFloat(),
            cweFlagCount.toFloat(),
            eceFlagCount.toFloat(),
            downUpRatio.toFloat(),
            avgPacketSize.toFloat(),
            avgFwdSegmentSize.toFloat(),
            avgBwdSegmentSize.toFloat(),
            fwdHeaderLengthSum.toFloat(), // Fwd Header Length.1 - duplicate
            0f, 0f, 0f, 0f, 0f, 0f, // Bulk fields (placeholder)
            totalFwdPackets.toFloat(),
            totalFwdBytes.toFloat(),
            totalBwdPackets.toFloat(),
            totalBwdBytes.toFloat(), // Subflow
            initWinBytesForward.toFloat(),
            initWinBytesBackward.toFloat(),
            actDataPktFwd.toFloat(),
            (if (minSegSizeForward == Int.MAX_VALUE) 0 else minSegSizeForward).toFloat(),
            (activeIdleStats["active_mean"] ?: 0.0).toFloat(),
            (activeIdleStats["active_std"] ?: 0.0).toFloat(),
            (activeIdleStats["active_max"] ?: 0.0).toFloat(),
            (activeIdleStats["active_min"] ?: 0.0).toFloat(),
            (activeIdleStats["idle_mean"] ?: 0.0).toFloat(),
            (activeIdleStats["idle_std"] ?: 0.0).toFloat(),
            (activeIdleStats["idle_max"] ?: 0.0).toFloat(),
            (activeIdleStats["idle_min"] ?: 0.0).toFloat()
        )

        return features.map { if (it.isFinite()) it else 0.0f }.toFloatArray()
    }
